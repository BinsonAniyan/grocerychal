function items() {
    ...
    xhttp.onreadystatechange = function () {
      ...
      `<div style="padding-bottom:10%;" id="myDIV" class="header">
       <button onclick="removeElement()" class="remBtn" id="Remove"><b>Remove items</b></button>
       <button class="btn " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" id="addd"><b>Add New item</b></button>
       <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
       <div class="offcanvas-header">
       <h5 id="offcanvasRightLabel" style=" font-family: cursive ;font-weight: bold;">Fill the fields</h5>
       <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
       </div>
       <div class="offcanvas-body">
              <div class="adds">
              <input type="number" id="Number" placeholder="Sn."><br>
              ...
              <input type="button" onclick="newElement()" class="addBtn" value="Add to list">
              </div>
              </div>
            </div>
...
function newElement() {
    ...
    td7.innerHTML = `<input type="checkbox" onclick="my_fun(${vau})" id="ckb${vau}">`
...
function removeElement() {
    ...
    document.getElementById("items").deleteRow(vau)
